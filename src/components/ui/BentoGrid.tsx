...
export const BentoGrid = ({ text }: { text: string }) => {
  ...
  const { cells: highlightedCells, width: gridWidth, height: gridHeight } = generateHighlightedCells(text);
  ...
  return (
    <section
      className="w-full max-w-xl bg-card border grid p-1.5 sm gap-0.5 sm rounded-[10px] sm:rounded-[15px]"
      style={{
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isHighlighted ? "animate-highlight bg-green-500" : "",
              shouldFlash ? "animate-flash bg-green-900/50" : "",
